...
import esp32
# --- LoRa Pins and SPI Bus Setup --- HT V2
lora_pins = {
    'dio_0': 26,        # DIO0 pin for interrupt
    'ss': 18,           # Slave Select (SS)
    'reset': 14,       # Reset pin
    'sck': 5,          # SPI Clock pin
    'miso': 19,         # SPI MISO pin
    'mosi': 27          # SPI MOSI pin
}
...
def lora_init():
    # Reset the SX1276
    Pin(21, Pin.OUT).value(0); time.sleep(0.01) 
